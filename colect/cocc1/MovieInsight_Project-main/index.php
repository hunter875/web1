        ...
        <div class="main-slider-box">
            <div class="main-slider-img">
                <form method="post" action="index.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
                    <img src="<?php echo $product_array[$key]["image"]; ?>" alt="Poster Venom3">
                </form>
            </div>
            <div class="main-slider-text">
                <div class="movie-name">
                    <span>2024</span>
                    <strong><?php echo $value["product"];  ?> </strong>
    ...
    ?>
        <div class="movie-card">
            <div class="movie-image">
                <img src="<?php echo $movie['image']; ?>" class="movie-thumb" alt="<?php echo $movie['name']; ?>">
                <button class="card-btn">Add to watchlist</button>
            </div>
            <div class="movie-info">
                <h2 class="movie-name"><?php echo $movie['name']; ?></h2>
                <p class="movie-short-description"><?php echo $movie['description']; ?></p>
                <span class="price"><?php echo $movie['rating']; ?></span>
